...
def mobile(request, data=None):
	...
	if data==None :
			mobiles = Product.objects.filter(category='M')
	elif data == 'Vivo' or data == 'Motorola' or data == 'Samsung' or data == 'iphone' or data == 'Realme' or data == 'Oppo':
...
def topwear(request, data=None):
	...
	if data==None :
		topwears = Product.objects.filter(category='TW')
	elif data == 't-shirt' or data == 'shirt' or data == 'w-top':
...
def bottomwear(request, data=None):
	...
	if data==None :
			bottomwears = Product.objects.filter(category='BW')
	elif data == 'Pants' or data == 'short' or data == 'w-bottom':
	...
	return render(request, 'app/bottomwere.html', {'bottomwears':bottomwears, 'totalitem':totalitem})
...
def laptop(request, data=None):
	...
	if data==None :
		laptops = Product.objects.filter(category='L')
	elif data == 'HP' or data == 'Lenovo' or data == 'ASUS':
